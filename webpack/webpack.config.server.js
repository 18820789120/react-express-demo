...
module.exports = [
  {
    ...
    module:{
      loaders:[
        ...
        { test: /\.(jpe?g|png|gif|svg|woff|eot|ttf)$/, loader: 'url?limit=10000&name=assets/img/[sha512:hash:base64:7].[ext]' },
        { test: /\.css$/, loader: ExtractTextPlugin.extract("style-loader", "css-loader") },
        // {test: /\.png$/, loader: "url-loadder"},
        // {test: /\.jpg$/, loader: "file-loadder"}
      ]
    },
    plugins: [
      new webpack.optimize.OccurenceOrderPlugin(),
      new ExtractTextPlugin("assets/styles1.css") //提取CSS. http://npm.taobao.org/package/extract-text-webpack-plugin
    ]
  }
]
